...
>>>>>>> refs/remotes/origin/경석님
		<tr>
			...
			<td><input type="button" id="id_check" name="id_check" onclick="window.open('/check.do','_blank','width=500, height=500');" value="아이디확인"></td>
		...
		<tr>
			...
			<td><input type="hidden" value="" name="pwdCheckValue" id="pwdCheckValue"></td>
		</tr>
		<tr>
			<th>이름</th>
...
function checkMember() {
	...
	if($("#pwdCheckValue").val()==null || $("#pwdCheckValue").val()==""){
